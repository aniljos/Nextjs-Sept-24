export const suppliers = [
    ...
    { id: 6, name: 'Gamma Distributors', contactPerson: 'Lisa Brown', email: 'lisa@gammadist.com', location: 'Boston' },
    { id: 7, name: 'Sunshine Supplies', contactPerson: 'Chris Green', email: 'chris@sunshine.com', location: 'Los Angeles' },
    { id: 8, name: 'Apex Manufacturing', contactPerson: 'Karen White', email: 'karen@apexmfg.com', location: 'Denver' },
    { id: 9, name: 'Prime Products', contactPerson: 'Robert Black', email: 'robert@primeproducts.com', location: 'Miami' },
